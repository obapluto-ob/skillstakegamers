...
def secure_headers(response):
    ...
    response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; style-src-elem 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; img-src 'self' data: https://images.unsplash.com https://cdn.jsdelivr.net https://img.icons8.com; font-src 'self' https://cdnjs.cloudflare.com"
    return response
