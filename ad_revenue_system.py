...
def init_ad_tables():
    ...
    ad_types = [
        ('banner', 0.50, 30.0, 70.0),  # KSh 0.50 per view, 30% to user, 70% to platform
        ('video', 2.00, 40.0, 60.0),   # KSh 2.00 per view, 40% to user, 60% to platform
        ('interstitial', 1.50, 35.0, 65.0),  # KSh 1.50 per view, 35% to user, 65% to platform
        ('rewarded', 3.00, 50.0, 50.0)  # KSh 3.00 per view, 50% to user, 50% to platform
    ]
